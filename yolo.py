...
class YOLOv8:
    ...
    def predict(
        ...
        """
        :param file_path: Image or video file.
            ...
            for p in frames_number_to_read:
                ...
                if frame_to_process is not None:
                    ...
                    if max_num_boxes != -1 and len(combined_boxes) > max_num_boxes:
                        combined_boxes = sorted(combined_boxes, key=lambda x: x["confidence"], reverse=True)[
                                         :max_num_boxes]
    ...
    def process_results(self, results, model_to_use) -> dict:
        results_dict = {
            "boxes": [],
        }
